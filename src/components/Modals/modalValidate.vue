    ...
    <template v-slot:body>
      <form @submit.prevent="onSubmit">
        ...
        <div class="form-item" :class="{ errorInput: v$.name.$error }">
          ...
          <p
            class="errorText"
            v-if="v$.name.minLength.$invalid && v$.name.$error"
          >
        ...
        <div class="form-item" :class="{ errorInput: v$.password.$error }">
          ...
          <input
            ...
            :class="{
              error: v$.password.$error && v$.confirmPassword.sameAs.$invalid,
            }"
          />
          <label>Repeat password:</label>
          <p class="errorText" v-if="v$.confirmPassword.sameAs.$invalid">
            Пароли не совпадают!
          </p>
          <input
